...
public class Farm implements FarmADT {
  ...
  private String date; // Most recent date of milk weight entered
  private long milkWeight; // Most recent milk weight that was entered
  ...
  /**
   * Gets the date of the most recent milk weight added or edited.
   * 
   * @return - date of most recent addition.
   */
  ...
  /**
   * Gets the weight of the most recent milk weight added or edited.
   * 
   * @return - weight of most recent addition.
   */
